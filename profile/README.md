...
<div align="center">
  <h1>Claude Studio - Claude Code 사용량 분석 도구</h1>
</div>

<div align="center">
  <img src="https://raw.githubusercontent.com/claude-studio/.github/main/assets/claude-studio.png" alt="Main" style="border-radius: 10px;"/>
</div>
...
- **라이브 모니터링 플러그인** — Claude Code Hooks 플러그인 설치 / 제거
...
<div align="center">
  <img src="https://raw.githubusercontent.com/claude-studio/.github/main/assets/claude-studio.png" alt="Claude Studio 개요" style="border-radius: 10px;"/>
</div>
...
**GitHub Releases** 에서 최신 버전을 다운로드하세요.
...
└── packages/
    ├── ui/              # 공유 React UI 라이브러리
    ├── shared/          # 공유 타입 / JSONL 파싱 / 비용 계산
    ├── pixel-agents/    # Canvas 2D 픽셀 오피스 엔진
